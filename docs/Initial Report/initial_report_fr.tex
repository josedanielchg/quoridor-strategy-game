...
\begin{itemize}[leftmargin=1.2em]
    \item Compilateur C++20
    \begin{itemize}[leftmargin=1.2em]
        \item Windows: MSVC (Visual Studio 2022 recommandé)
        \item Linux: g++ ou clang++
    \end{itemize}
    \item CMake \textbf{3.22} ou plus récent
    \item Git
    \item SFML \textbf{3.0}
    \begin{itemize}[leftmargin=1.2em]
        \item Ce dépôt est configuré pour récupérer et construire SFML automatiquement via CMake FetchContent.
    \end{itemize}
\end{itemize}

\subsection*{Dépendances Linux}
...
\subsection*{Note sur les policies CMake}
