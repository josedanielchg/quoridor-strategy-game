...
Heuristique et Architecture POO
Moderne \par}
    \vspace{2.8cm}
...
% GAME OVERVIEW
% ====================================================
\section{Présentation du jeu : qu’est-ce que ``Corridor'' ?}
...
Le processus de compilation est géré avec CMake (version minimale \textbf{3.16}). Le projet cible SFML version \textbf{3.0}. La configuration de build peut être adaptée pour Windows (MSVC) ou Linux (g++/clang).
...
\begin{itemize}[leftmargin=1.2em]
    ...
    \item CMake \textbf{3.16} ou plus récent
    \item SFML \textbf{3.0}
    \item Git
\end{itemize}
